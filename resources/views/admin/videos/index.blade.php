...
@section('content')
  <div class="mb-3 d-flex align-items-center justify-content-between">
    ...
    <a href="{{ route('admin.videos.create') }}" class="btn btn-primary">
      <i class="ti ti-circle-plus me-1"></i> Nouvelle vidéo
    </a>
  </div>
    ...
    <div class="card-body p-0">
      <div class="table-responsive">
        <table class="table align-middle mb-0">
          ...
          @forelse($videos as $video)
            <tr>
              <td class="fw-semibold">
                <a href="{{ route('admin.videos.show',$video) }}" class="text-decoration-none">{{ $video->title }}</a>
              </td>
              ...
              <td class="text-end">
                <div class="d-inline-flex gap-2">
                  <a href="{{ route('admin.videos.show',$video) }}" class="btn btn-sm btn-outline-secondary">
          ...
          @empty
            <tr><td colspan="6" class="text-center py-5">Aucune vidéo.</td></tr>
          @endforelse
          </tbody>
        </table>
      </div>
