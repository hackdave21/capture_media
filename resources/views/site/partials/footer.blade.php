...
<footer id="footer" class="footer">
        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6 footer-about">
                ...
                <div class="footer-contact pt-3">
                    ...
                    <p><strong>Email:</strong> <span>capturedreamsmakers@gmail.com</span></p>
                </div>
                <div class="social-links d-flex mt-4">
                    <a href="https://www.facebook.com/share/1AacLUBLTi/?mibextid=wwXIfr"><i class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/cap.ture.media?igsh=MXdncnd1b25pZTM4cg%3D%3D&utm_source=qr"><i class="bi bi-instagram"></i></a>
                    <a href="https://www.tiktok.com/@capture.media0?_t=ZM-8xTAWNfnRlF&_r=1"><i class="bi bi-tiktok"></i></a>
                </div>
            </div>
                        ...
                        <div class="col-4 col-sm-3">
                            @if ($s->image)
                                <a href="{{ $s->url ?? '#' }}" target="_blank" class="d-inline-block">
                                    <img src="{{ Storage::url($s->image) }}" class="img-fluid rounded"
                                        alt="{{ $s->name }}">
                                </a>
                            @else
    ...
    <div class="container copyright text-center mt-4">
        <p>© <span>{{ date('Y') }}</span> <strong class="px-1 sitename">Capture Media</strong> <span>Tous droits
                réservés</span></p>
        <small class="credits">Develop by <a href="https://portfolio-lidaouwe-alawi.netlify.app/" target="_blank">THS</a></small>
    </div>
</footer>
